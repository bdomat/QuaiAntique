...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::subMenu('Plats', 'fa fa-fish-fins')->setSubItems([
            MenuItem::linkToCrud('Ajouter une catégorie', 'fa fa-plus', DishesCategories::class)->setAction(Crud::PAGE_NEW),
            MenuItem::linkToCrud('Liste des catégories', 'fa fa-list', DishesCategories::class),
